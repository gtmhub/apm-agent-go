...
package apmamqp091 // import "github.com/ekrucio/apm-agent-go/module/apmamqp091/v2"
...
// apmamqp091.WrappedChannel which wraps amqp.Channel
// in a traced manner
func WrapChannel(ch *amqp.Channel) WrappedChannel {
	return WrappedChannel{Channel: ch, ctx: context.Background()}
}

// WithContext supplies context.Context to apmamqp091.WrappedChannel.
